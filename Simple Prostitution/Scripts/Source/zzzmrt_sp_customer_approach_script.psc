...
Event OnInit()
	if self.isrunning() && MainScript.bPreventFruitlessApproaches && (approachingCustomerAlias && approachingCustomerAlias.GetReference()) && !((approachingCustomerAlias.getReference() as Actor).isInDialogueWithPlayer())
